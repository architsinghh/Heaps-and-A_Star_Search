...
curl -L -O https://bytes.usc.edu/cs104/homework/test-suites/hw3_tests.tar.gz || { echo "::error::Unable to download graded tests. Try again."; exit 1; }
tar xvf hw3_tests.tar.gz || { echo "::error::Error downloading graded tests. Try again."; exit 1; }
cp -rf ./hw3_tests/* .
...
test_directories=("heap_tests") # Won't be used in Grading-mode
# End TODO
