...
weightsConfig = ["minheap.config", "doublet.config"] # Leave array empty or have one empty string if using no weights (if CMakeLists.txt has IS_CHECKER set to TRUE).
...
gradeFileName = "GR3_hw-username.md" # File that `make grade` outputs the score to
